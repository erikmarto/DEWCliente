/*PRÁCTICA 1 JUEGO: "EL AHORCADO"

-Mostrará un botón "Empezar juego" que abrirá un mensaje en ventana emergente pidiendo la palabra a adivinar. 
Una vez introducida el botón "Empezar juego" desparecerá.

-Se mostrará una tabla vacía con tantas casillas como letras tenga la palabra.

-Un input "Elige letra" permitirá introducir la letra para adivinar la palabra y el botón "comprobar letra" comprobará si la letra está en la palabra 
en cuyo caso la mostrará en su posición correcta en la tabla, si no se encuentra muestra la primera letra de AHORCADO 
y así sucesivamente hasta completar la palabra o terminar ahorcado.

-Cuando termina en cualquiera de los casos muestra el texto "Has ganado" o "Has perdido".*/
...
window.onload = function () {
    ...
    const arrayPalabras = ["Coco", "Luz", "Fuente", "Casa", "Enorme", "Silla", "Ordenador", "Pizarra", "Pantalon", "Fiesta",
        "Parque", "Escaleras", "Videojuegos", "Deporte", "Insecto", "Amistad", "Pulpo", "Lluvia", "Naranja", "Matematicas", "Mochila", "Servir", "Deletrear"];
